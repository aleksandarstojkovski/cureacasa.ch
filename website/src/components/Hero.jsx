    ...
    return (
        <section className="relative py-20 lg:py-32 bg-[#ecf5fa] overflow-hidden">
            <SEO
                ...
                keywords="infermiera a domicilio, infermiera Locarno, cure a domicilio Ticino, assistenza domiciliare, sanità a casa, iniezioni a domicilio, medicazioni"
                    ...
                    <div className="w-full lg:w-2/3 lg:pl-12">
                        <div className="flex flex-col items-start gap-3 mb-6">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white text-primary-600 text-sm font-medium shadow-sm border border-primary-100">
                                ...
                                <span>Infermiera Indipendente in Ticino</span>
                            </div>
