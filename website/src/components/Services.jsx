...
import { Stethoscope, HeartPulse, Activity, UserCheck, Syringe, ClipboardList, Users } from 'lucide-react';
import SEO from './SEO';
...
const Services = () => {
    const services = [
        ...
        },
        {
            ...
            title: "Collaborazioni Interdisciplinari",
            description: "Collaborazioni con fisioterapisti, ergoterapisti, medici ed altri professionisti per garantire una presa a carico olistica."
        }
    ];
